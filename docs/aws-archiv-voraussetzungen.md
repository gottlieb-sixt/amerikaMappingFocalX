...
| 6 | ~~**Dienstkonto**~~ | Für den Push-Betrieb nicht nötig: FocalX liefert das fertige Report-JSON mit signierten Bildadressen; unsere Lambda braucht kein FocalX-Login. Zugangsdaten werden nur noch für das manuelle Nachladen benötigt |
...
| 10 | **Wie wird der API-Key übergeben und rotiert?** | API Gateway verwaltet ihn im Usage Plan; die Lambda sieht ihn nie. Zwei gleichzeitig gültige Schlüssel ermöglichen einen Wechsel ohne Unterbrechung |
